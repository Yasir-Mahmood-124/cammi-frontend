...
const DashboardPage = () => {
  ...
  const documents: Document[] = [
    { id: 1, name: "Business Plan", imageUrl: "/images/docs/doc1.png" },
    { id: 2, name: "GTM Strategy", imageUrl: "/images/docs/doc2.png" },
    { id: 3, name: "AI Proposal", imageUrl: "/images/docs/doc3.png" },
  ];
                      ...
                      <Box display={"flex"}>
                        ...
                        >
                          <img
                            ...
                            alt={doc.name}
                            style={{
                              width: "100%", // fills the Box width
                              height: "100%", // fills the Box height
                              objectFit: "contain",
                            }}
                          />
                        </Box>
