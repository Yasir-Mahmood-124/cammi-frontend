...
import { onboardingData } from "./data"; // ✅ import data

// ✅ Default card background
const cardDefaultBackground = `
...
export default function OnboardingPage() {
  ...
  const handleNext = () => {
    if (step < onboardingData.length - 1) {
      ...
      // TODO: Navigate to dashboard or summary
    }
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography
            align="center"
            sx={{ fontSize: "30px", fontWeight: 700, mb: 3 }}
          >
            ...
            {currentData.options.map((title, idx) => {
              ...
              return (
                ...
                >
                  <Card
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        ...
                        border: "2px solid",
                        borderImageSource:
                          "linear-gradient(270deg, #3EA2FF 0%, #FF3C80 100%)",
                        borderImageSlice: 1,
                  ...
                  >
                    <Typography
                      sx={{ fontWeight: 500, px: 1, fontSize: 14 }}
                    >
                      {title}
                    </Typography>
                  </Card>
